...
- Change summary: P0/P1 remediation: hardened unknown-path noindex behavior, pricing/resources routing, and checkout plan aliases, then redeployed.
- Touched files: worker/index.js.
- Verification: Deploy completed; route checks passed; payment still depends on provider configuration/state.
...
- Added one contextual related-resource link to MiroFish AI Simulator with UTM tracking for deepfakedetection.site.
